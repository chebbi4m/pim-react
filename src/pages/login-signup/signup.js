...
export function SignUp() {
  const navigateToLogin = () => {
    console.log("success");
    window.location.href = "/login"; // Navigate to the sign-up page directly
  };
  ...
  return(
    <div className='container'>
      ...
      <div className='login'>Already have an account? <span onClick={navigateToLogin}>click here to login</span></div>
